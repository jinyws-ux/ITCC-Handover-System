...
export type Dashboard = { currentDate: string; currentShift: { code: string; time: string; group: string }; nextShift: { code: string; time: string; group: string }; sections: { waitingNextShift: Task[]; monitoring: Task[]; noticeOnly: Task[]; todayHypercare: Task[]; needConfirmation: Task[]; recentlyUpdated: Task[] } }
...
export const emptyDash: Dashboard = { currentDate: '-', currentShift: { code: '-', time: '-', group: '-' }, nextShift: { code: '-', time: '-', group: '-' }, sections: { waitingNextShift: [], monitoring: [], noticeOnly: [], todayHypercare: [], needConfirmation: [], recentlyUpdated: [] } }
