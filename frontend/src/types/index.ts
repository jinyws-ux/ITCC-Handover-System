...
export type Dashboard = { businessDate: string; businessStart: string; businessEnd: string; currentShift: { code: string; time: string; group: string }; nextShift: { code: string; time: string; group: string }; summary: { actionRequired: number; monitoring: number; hypercareToday: number; completedToday: number; criticalHigh: number }; sections: { actionRequired: Task[]; monitoring: Task[]; hypercare: Task[]; completed: Task[] } }
...
export const emptyDash: Dashboard = { businessDate: '-', businessStart: '-', businessEnd: '-', currentShift: { code: '-', time: '-', group: '-' }, nextShift: { code: '-', time: '-', group: '-' }, summary: { actionRequired: 0, monitoring: 0, hypercareToday: 0, completedToday: 0, criticalHigh: 0 }, sections: { actionRequired: [], monitoring: [], hypercare: [], completed: [] } }
